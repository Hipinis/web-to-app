...
│   │   └── ForcedRunHardwareController.kt # 黑科技功能
│   ├── i18n/                # 多语言支持
│   ├── isolation/           # 独立浏览器环境
│   │   └── IsolationManager.kt # 指纹伪装/多开隔离
│   ├── shell/               # Shell模式管理
│   └── webview/             # WebView管理
│       ├── TranslateBridge.kt # 翻译桥接
│       ├── NativeBridge.kt  # 原生能力桥接
